...
export const BANNER_IMAGES =  [
  {
    src: '/images2/banner/banner1.jpg',
    text: 'Los Murciélago Eliminan Insectos Y Pestes Que Consumen Las Cosechas.'
  },
  {
    src: '/images2/banner/banner0.jpg',
    text: 'Es Imperativo Cuidar De Esta Especie Y Romper Muchos Mitos Y Mentiras Acerca De Ellos.'
  },
  {
    src: '/images2/banner/banner2.jpg',
    text: 'El principal peligro al que se enfrentan es el ataque directo del ser humano.'
  },
  {
    src: '/images2/banner/banner3.jpg',
    text: 'Se Tienen Registradas Más De 1,300 Especies a Nivel Mundial, Representando El 20% De Las Variedades De Mamíferos Del Planeta.'
  }
]
